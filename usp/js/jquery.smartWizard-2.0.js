    ...
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
                  ...
                  btNext = $('<a id = "next">'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext");
                  btPrevious = $('<a id = "previous">'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious");
                  btFinish = $('<a id = "finish">'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish");
